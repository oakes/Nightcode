...
Xe.setTextContent=function(a){return Re(document.querySelector("#content"),a)};Xe.getTextContent=Ve;Xe.getSelectedText=function(){return null};Xe.markClean=We;Xe.isClean=function(){var a=C(Se);a=null==a?null:se.a(a);return null==a?null:O.b(a,Ve())};Xe.changeTheme=function(a){var b=C(Se);b=null==b?null:ve.a(b);return null==b?null:b.setOption("theme",r(a)?"lesser-dark":"default")};Xe.setTextSize=function(a){return document.querySelector(".CodeMirror").style.fontSize=[w.a(a),"px"].join("")};
Xe.openModal=function(){return Te.style.display="block"};
